...
| `0x000C` | `REG_HOOK_TIMESTAMP_H` | 吊钩 | 上一次成功更新时间戳高 16 位 |
| `0x000D` | `REG_HOOK_TIMESTAMP_L` | 吊钩 | 上一次成功更新时间戳低 16 位 |
| `0x000E` | `REG_HOOK_ERROR_CODE` | 吊钩 | RTU通信错误码，`0` 表示正常 |
| `0x000F` | `REG_HOOK_ONLINE_CODE` | 吊钩 | 在线码，`1` 表示最近一次通信正常，`0` 表示异常 |
| `0x0010` | `REG_HOOK_TRUN_CNT` | 吊钩 | 圈数 |
| `0x0011` | `REG_HOOK_SINAGLE_VAL` | 吊钩 | 单圈值 |
...
| 吊钩 `HOOK` | `[12]` 到 `[17]` | `0x000C` 到 `0x0011` |
...
| 吊钩 `HOOK` | `04` | `0x000F` | `3` | 在线码、圈数、单圈值 |
