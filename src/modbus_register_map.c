...
#define MODBUS_DEVICE_CAPABILITY_FLAGS \
	((IS_ENABLED(CONFIG_CRANE_ENCODER_USE_SLEWING) ? DEVICE_CAPABILITY_SLEWING_ENCODER : 0U) | \
	 (IS_ENABLED(CONFIG_CRANE_ENCODER_USE_LUFFING) ? DEVICE_CAPABILITY_LUFFING_ENCODER : 0U) | \
	 (IS_ENABLED(CONFIG_CRANE_ENCODER_USE_HOISTING) ? DEVICE_CAPABILITY_HOISTING_ENCODER : 0U) | \
