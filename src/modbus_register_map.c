...
static struct modbus_register_input input_register_table[] = {
	...
	{ .name = "REG_SLEWING_OFFLINE_STATUS", .addr = 0x0003, .default_value = 0 },
	...
	{ .name = "REG_LUFFING_OFFLINE_STATUS", .addr = 0x0009, .default_value = 0 },
	{ .name = "REG_LUFFING_TRUN_CNT", .addr = 0x000A, .default_value = 0 },
	{ .name = "REG_LUFFING_SINAGLE_VAL", .addr = 0x000B, .default_value = 0 },
	{ .name = "REG_HOISTING_TIMESTAMP_H", .addr = 0x000C, .default_value = 0 },
	{ .name = "REG_HOISTING_TIMESTAMP_L", .addr = 0x000D, .default_value = 0 },
	{ .name = "REG_HOISTING_ERROR_CODE", .addr = 0x000E, .default_value = 0 },
	{ .name = "REG_HOISTING_OFFLINE_STATUS", .addr = 0x000F, .default_value = 0 },
	{ .name = "REG_HOISTING_TRUN_CNT", .addr = 0x0010, .default_value = 0 },
	{ .name = "REG_HOISTING_SINAGLE_VAL", .addr = 0x0011, .default_value = 0 },
};
